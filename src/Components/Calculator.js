...
const Calculator = () => {
  ...
  return (
    <div className='calculator'>
      ...
      <input type='text' id='num1' name='num1' placeholder='Num 1' value ={num1} onChange ={(e) => {setBtnClick(false);setNum1(e.target.value)}}/>
      <input type='text' id='num2' name='num2' placeholder='Num 2' value ={num2} onChange ={(e) => {setBtnClick(false);setNum2(e.target.value)}}/>
